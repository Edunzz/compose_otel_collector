...
const pokemons = [
  ...
  { id: 2, name: 'Charmander', type: 'Fire', level: 20 },
  { id: 3, name: 'Squirtle', type: 'Water', level: 18 },
  { id: 4, name: 'Bulbasaur', type: 'Grass', level: 22 },
  { id: 5, name: 'Caterpie', type: 'Bug', level: 10 },
];
